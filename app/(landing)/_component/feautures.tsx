...
import { TruthSlider } from '@/components/trush-sildes-filter'

import React from 'react'
import dynamic from "next/dynamic";
import FeaturesSection from '@/components/contentfeutrues'
const World = dynamic(() => import("../../../components/interactive-globe").then((m) => m.World), {
  ssr: false,
});
    ...
    <section className="relative pt-20 pb-32  overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <TruthSlider
              filteredImage="https://images.unsplash.com/photo-1590490360182-c33d57733427?q=80&w=1000&auto=format&fit=crop"
              truthImage="https://images.unsplash.com/photo-1566665797739-1674de7a421a?q=80&w=1000&auto=format&fit=crop"
            />
          </div>
        </div>
      </div>
      <div className=' container mx-auto px-4'>
         <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="flex flex-row items-center justify-center py-10 h-screen md:h-auto  bg-white relative w-full">
                <BackgroundRippleEffect/>
